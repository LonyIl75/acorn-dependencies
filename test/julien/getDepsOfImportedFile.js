...
import {getDependenciesName,depAndDeclFieldName} from "../../acorn/src/julien/DeclAndDep/declAndDep.js"
...
export const str_props_import = strArrToFieldName(str_props, getLabelFromTokenType(tt._import))
export const str_props_export = strArrToFieldName(str_props, getLabelFromTokenType(tt._export))
