...
import {keywords as keywordTypes, getLabelFromTokenType} from "./tokentype.js"
...
import {ju_skipBlockComment} from "./julien/extendsAcorn.js"
import {boolOrUnknown} from "./julien/boolOrUnknown.js"
...
// ICI extendsion ju : /* ju_ts_type : type */ , exemple : /* ju_ts_type : string */
pp.skipBlockComment = function() {
  ...
  if (boolOrUnknown.isTrue(this.maybeInformativeComment))ju_skipBlockComment(this, this.input.slice(start + 2, end))
}
...
function stringToBigInt(str) {
  if (typeof BigInt !== getLabelFromTokenType(tt._function)) {
    return null
  }
