...
import {ju_parserPropsInit} from "./julien/extendsAcorn.js"

export class Parser {
  constructor(options, input, startPos, ju_args) {
    ...
    this.strict = false // TODO DECOMMENT : //this.inModule || this.strictDirective(this.pos)
    ...
    this.scopeStack = []
    this.enterScope(SCOPE_TOP, null, true)
    ...
    ju_parserPropsInit(this, ju_args)
  }
  ...
  static parse(input, options, startPos, ju_args) {
    return new this(options, input, startPos, ju_args).parse()
  }
